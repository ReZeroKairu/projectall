    ...
    <div className="min-h-screen flex flex-col bg-gray-100">
      <div className="flex-grow flex pt-20">
        <div className="w-60 p-4 border border-black border-b-0 bg-gray-300">
          <h2 className="text-xl font-bold mb-4 border-b-2 border-black pb-2 pt-2 text-center">
            MENU
          </h2>
          <button
            className={`w-full py-2 px-4 text-left ${
              activeTab === "Home" ? "bg-gray-500" : ""
            }`}
          ...
          <button
            className={`w-full py-2 px-4 text-left ${
              activeTab === "Submit Manuscript" ? "bg-gray-500" : ""
            }`}
          ...
          <button
            className={`w-full py-2 px-4 text-left ${
              activeTab === "Manuscripts" ? "bg-gray-500" : ""
            }`}
          ...
          <button
            className={`w-full py-2 px-4 text-left ${
              activeTab === "Discussions" ? "bg-gray-500" : ""
            }`}
          ...
          <button
            className={`w-full py-2 px-4 text-left ${
              activeTab === "Contact Us" ? "bg-gray-500" : ""
            }`}
